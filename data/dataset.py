...
def load_bios(
    ...
    """
    Load Bias in Bios from HuggingFace, build vocab, and return
    (train_loader, valid_loader, test_loader, vocab, id2profession).

    Args:
        subset: fraction of data to use (0.0–1.0). Use 0.05 for fast CPU dev runs.
    """
    ...
    # Vocab built on train text only (gender label not needed for vocab)
    ...
    return train_loader, valid_loader, test_loader, vocab, ID2PROFESSION
